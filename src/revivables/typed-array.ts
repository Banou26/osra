...
import {
  ...
  type TypeArrayType as TypedArrayType,
  type TypedArray
} from '../utils'

export { typedArrayToType, typedArrayTypeToTypedArrayConstructor, type TypedArrayType }
export type { TypedArray, TypedArrayConstructor } from '../utils'

export const type = 'typedArray' as const

export const isType = (value: unknown): value is TypedArray => isTypedArray(value)
