...
const typedArrays = [
  ...
  new Int32Array(),
  new Uint32Array(),
  ...(typeof Float16Array !== 'undefined' ? [new Float16Array()] : []),
  new Float32Array(),
  new Float64Array(),
  new BigInt64Array(),
  new BigUint64Array()
...
export const typedArrayToType = <T extends TypedArray>(value: T) => {
  const type =
    ...
    (typeof Float16Array !== 'undefined' && value instanceof Float16Array) ? 'Float16Array' :
...
export const typedArrayTypeToTypedArrayConstructor = (value: TypedArrayType): TypedArrayConstructor => {
  const typedArray =
    ...
    (value === 'Float16Array' && typeof Float16Array !== 'undefined') ? Float16Array :
